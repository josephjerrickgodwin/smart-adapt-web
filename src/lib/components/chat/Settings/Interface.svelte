...
>
	...
	<div class=" space-y-3 overflow-y-scroll max-h-[28rem] lg:max-h-full">
		<div>
			...
			<div class="mt-5 my-1.5 text-sm font-medium">{$i18n.t('Chat')}</div>
			...
			<div class="mt-5 my-1.5 text-sm font-medium">{$i18n.t('Voice')}</div>
...
<!--			<div class="mt-5 my-1.5 text-sm font-medium">{$i18n.t('File')}</div>-->
