...
AS $$
DECLARE
  project_url TEXT := 'https://tmzqoepxdyueifkmebaz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRtenFvZXB4ZHl1ZWlma21lYmF6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNjUzMzUwMSwiZXhwIjoyMDUyMTA5NTAxfQ.KoP4jpyNj1VWltBtCy8azcRDf2EgUIX0YCLhUr8KRds'; -- full access needed for http request to storage
